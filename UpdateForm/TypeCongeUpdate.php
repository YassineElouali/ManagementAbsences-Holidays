    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Modifier Type de congé :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../UpdateForm/TypeCongeModif.php?id=<?php echo $id; ?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="tclibelle" value="<?php echo $b->getLibelle();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>

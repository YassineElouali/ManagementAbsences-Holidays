                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../UpdateForm/ServiceModif.php?id=<?php echo $id;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th valign="top">Service Libelle:</th>
                                                        <td><input type="text" class="inp-form" name="slibelle" value="<?php echo $b->getLibelle(); ?>"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>

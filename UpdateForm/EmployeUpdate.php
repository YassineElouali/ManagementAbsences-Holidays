...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Employe Modification</title>
    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Modifier Employé :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="EmployeModif.php?id=<?php echo $ide;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="eg"><?php
                                                                ...
                                                                <option value="<?php echo $c->getId(); ?>" <?php  if($b->getEg()==$c->getId()) echo "selected"; ?>     > <?php echo $c->getLibelle(); ?></option>
                                                                    <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="nom" value="<?php echo $b->getNom();  ?>"></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="prenom" value="<?php echo $b->getPrenom();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="tel" value="<?php echo $b->getTel();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="adresse" value="<?php echo $b->getAdresse();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="email"  value="<?php echo $b->getEmail();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                        <tr>
                                                       
                                                        <th valign="top">Mot de passe :</th>
                                                        <td><input type="text" class="inp-form" name="mdpp" value="<?php echo $b->getMdp();  ?>" ></td>
                                                        <td></td>
                                                    </tr>
                                                        <tr>
                                                       
                                                        <th valign="top">Salaire :</th>
                                                        <td><input type="text" class="inp-form" name="salaire" value="<?php echo $b->getSalaire();  ?>" ></td>
                                                        <td></td>
                                                    </tr>

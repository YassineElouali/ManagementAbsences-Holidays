    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Modifier cette demande de Congé :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="CongeModif.php?id=<?php echo $id;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                 <?php  include_once '../Services/CongeService.php'; 
                                                 ...
                                                 include_once '../Services/TypeCongeService.php';
                                                                    $cn = new TypeCongeService();
                                                                    $r = $cn->getAll();
                                                                    foreach ($r as $c) {
                                                                        ?>
                                                                    
                                                                <option value="<?php echo $c->getId(); ?>"  <?php  if($b->getType()==$c->getId()) echo "selected"; ?>      > <?php echo $c->getLibelle(); ?></option>
                                                                    <?php
                                                    ...
                                                    <tr>
                                                        <th valign="top">Jour Debut :</th>
                                                        <td><input type="date" name="Jdebut" value="<?php  echo $b->getJdebut();     ?>" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th valign="top">Jour Fin :</th>
                                                                <td><input type="date" name="Jfin" value="<?php  echo $b->getJfin();     ?>" /></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>

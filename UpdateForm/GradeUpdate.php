    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Modifier Grade :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="GradeModif.php?id=<?php echo $id;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <?php include_once '../Services/GradeService.php';
                                                    $a=new GradeService();
                                                    $b=$a->getById($id);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th valign="top">Grade Libelle:</th>
                                                        <td><input type="text" class="inp-form" name="glibelle" value="<?php echo $b->getLibelle();  ?>"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>

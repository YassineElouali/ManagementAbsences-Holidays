    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Modifier demande d'absence :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="AbsenceModif.php?id=<?php echo $id;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    <tr>
                                                        ...
                                                        <th valign="top">Jour :</th>
                                                        <td><input type="date" class="inp-form" name="jours" value="<?php echo $b->getJours();  ?>"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <th valign="top">Motif :</th>
                                                        <td><textarea name="motif" rows="4" cols="20"  value="<?php echo $b->getMotif(); ?>"><?php echo $b->getMotif(); ?></textarea> </td>
                                                        <td></td>
                                                    </tr>

    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <h1>Liste des Absences Non Justifié :</h1>
                </div>
                <!-- end page-heading -->
                                    ...
                                    if (isset($_GET['add'])) {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                ...
                                                <td class=green-left id=succes >Grade ajouter avec succes !!</td>
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <tr>
                                               ...
                                               <!-- <th class="table-header-repeat line-left minwidth-1"><a href="">Absence id</a>	</th>
                                                ...
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Date de cette demande</a></th>

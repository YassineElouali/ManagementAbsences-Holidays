                                                    ...
                                                    <tr>
                                                        <script   type="text/javascript">
                                                            ...
                                                            { 
                                                                ...
                                                                ajax.open('GET', 'GradeFiltre.php?lib=' + str + '&ide=<?php echo $ide; ?>', true);
                                                        ...
                                                        <input type="text" name="filtre" placeholder="Filtrer" oninput="a(this.value);" /><br><br>
                                                                </tr>
                                                                <tr>
                                                                    <th class="table-header-check"><a id="toggle-all" ></a> </th>
                                                                    <!--<th class="table-header-repeat line-left minwidth-1"><a href="">Grade id</a>	</th>-->
                                                                    <th class="table-header-repeat line-left minwidth-1"><a href="">Grade libelle</a></th>
                                                                ...
                                                                <tbody id="output">
                                                                    ...
                                                                    foreach ($t as $key => $v) {
                                                                        ...
                                                                        echo "<a href=" . "../UpdateForm/GradeUpdate.php?ide=" . $ide . "&id=" . $v->getId() . " title=Modifier class=icon-1 info-tooltip></a>";
                                                                        echo "<a href=" . "../DeleteForm/GradeDelete.php?ide=" . $ide . "&id=" . $v->getId() . " title=Supprimer class=icon-2 info-tooltip></a>";
                                                                        echo "</td></tr>";
                                                                        $i++;
                                                                    }
                                                                    ?>
                                                                ...
                                                                <div id="actions-box">
                                                                    ...
                                                                    <div id="actions-box-slider">
                                                                        <a href="../Formulaire/GradeForm.php?ide=<?php echo $ide; ?>" class="action-edit">Ajouter</a>

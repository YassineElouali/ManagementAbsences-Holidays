    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Detail de l'employé :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../UpdateForm/EmployeUpdate.php?id=<?php echo $id;?>&ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <label class="inp-form" name="grade" ><?php echo $d->getLibelle();  ?></label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><label class="inp-form" ><?php echo $b->getNom();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><label  class="inp-form" name="prenom" ><?php echo $b->getPrenom();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><label  class="inp-form" name="tel" ><?php echo $b->getTel();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><label class="inp-form" name="adresse" ><?php echo $b->getAdresse();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><label class="inp-form" name="email"><?php echo $b->getEmail();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        <tr>
                                                       
                                                        <th valign="top">Mot de passe :</th>
                                                        <td><label class="inp-form" name="mdpp" ><?php echo $b->getMdp();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        <tr>
                                                       
                                                        <th valign="top">Salaire :</th>
                                                        <td><label class="inp-form" name="salaire" ><?php echo $b->getSalaire();  ?></label></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <th valign="top">Solde :</th>
                                                        <td><label class="inp-form" ><?php echo $b->getSolde();  ?></label></td>
                                                        <td></td>
                                                    </tr>

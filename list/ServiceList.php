                                ...
                                <div id="table-content">
                                    ...
                                    /* Suppression */ {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=red-left >Service supprimé avec succes !! </td>
                                    ...
                                    if (isset($_GET['add'])) {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                ...
                                                <td class=green-left id=succes >Service ajouter avec succes !!</td>
                                                ...
                                                <tr>
                                                    <script   type="text/javascript">
                                                        function a(str)
                                                        {
                                                            ...
                                                            ajax.open('GET', 'ServiceFiltre.php?lib=' + str + '&ide=<?php echo $ide; ?>', true);
                                                    ...
                                                    <input type="text" name="filtre" placeholder="Entrer Libelle" oninput="a(this.value);" /><br><br>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                             ...
                                                             <!--   <th class="table-header-repeat line-left minwidth-1"><a href="">Service id</a>	</th> -->
                                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Service libelle</a></th>
                                                            ...
                                                            <tbody id="output">
                                                                ...
                                                                foreach ($t as $key => $v) {
                                                                    ...
                                                                    echo "<a href=" . "../UpdateForm/ServiceUpdate.php?ide=" . $ide . "&id=" . $v->getIds() . " title=Modifier class=icon-1 info-tooltip></a>";
                                                                    echo "<a href=" . "../DeleteForm/ServiceDelete.php?ide=" . $ide . "&id=" . $v->getIds() . " title=Supprimer class=icon-2 info-tooltip></a>";
                                                                    echo "</td></tr>";
                                                                    $i++;
                                                                }
                                                                ?>
                                                            ...
                                                            <div id="actions-box">
                                                                ...
                                                                <div id="actions-box-slider">
                                                                    <a href="../Formulaire/ServiceForm.php?ide=<?php echo $ide; ?>" class="action-edit">Ajouter</a>

                                ...
                                <div id="table-content">
                                    ...
                                    /* Suppression */ {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=red-left >Grade supprimé avec succes !! </td>
                                    ...
                                    if (isset($_GET['add'])) {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                ...
                                                <td class=green-left id=succes >Absence Ajouter Avec Succes !!</td>
...
//<!--  start message-yellow -->
                                    if (isset($_GET['update'])) {
                                        ...
                                        echo" <table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=yellow-left>Absence Modifier avec Succes !!. </td>
...
//<!--  end message-yellow -->
                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <tr>
                                               ...
                                               <!-- <th class="table-header-repeat line-left minwidth-1"><a href="">Absence id</a>	</th> -->
                                              <?php
                                              ...
                                              if($h->getLibelle() != "Employe") echo"<th class=table-header-repeat line-left minwidth-1 ><a href= >Employe</a></th>"; ?>
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">le  </a></th>
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Motif</a></th>
                                               ...
                                               if ($h->getLibelle() == "Employe") { echo "<th class=table-header-repeat line-left minwidth-1><a href= >Option</a></th>" ;} ?>
                                            ...
                                            foreach ($t as $key => $v) {
                                                if ($v->getEtat() == "Non Justifie") {
                                                    ...
                                                    //echo"<td>" . $v->getId() . "</td>";
                                                    $f=$e->getById($v->getIde());
                                                    if ($h->getLibelle() != "Employe") echo"<td>" . $f->getNom() ." ". $f->getPrenom() . "</td>";
                                                    echo"<td>" . $v->getJours() . "</td>";
                                                    echo"<td>" . $v->getMotif() . "</td>";
                                                    echo"<td>" . $v->getEtat() . "</td>";
                                                    
                                                    
                                                   if ($h->getLibelle() != "Employe") {  echo "<td>";echo "<a href=" . "../action/AbsenceAccepter.php?ide=" . $ide . "&id=" . $v->getId() ."&ids=" . $v->getIde() . " title=Justifié class=icon-accept info-tooltip></a>";
                                                   echo "</td>";}
                                                   
                                                 if ($h->getLibelle() == "Employe") {echo "<td class=options-width >";
                                                    echo "<a href=" . "../UpdateForm/AbsenceUpdate.php?ide=" . $ide . "&id=" . $v->getId() . " title=Modifier class=icon-1 info-tooltip></a>";
                                                    echo "<a href=" . "../DeleteForm/AbsenceDelete.php?ide=" . $ide . "&id=" . $v->getId() . " title=Supprimer class=icon-2 info-tooltip></a>";
                                                 echo "</td>"; }
                                ...
                                <div id="actions-box">
                                    ...
                                    <div id="actions-box-slider">
                                        <a href="../Formulaire/AbsenceForm.php?ide=<?php echo $ide; ?>" class="action-edit">Ajouter</a>

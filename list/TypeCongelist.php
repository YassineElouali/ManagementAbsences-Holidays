    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <h1>Liste des Types de Congé :</h1>
                </div>
                <!-- end page-heading -->
                            ...
                            <div id="content-table-inner">
                                ...
                                <div id="table-content">
                                    ...
                                    /* Suppression */ {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=red-left >Type de congé supprimé avec succes !! </td>
                                    ...
                                    if (isset($_GET['add'])) {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                ...
                                                <td class=green-left id=succes >Un nouveau type de congé ajouter avec succes !!</td>
                                    ...
                                    <form id="mainform" action="">
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <tr>
                                              ...
                                              <!--  <th class="table-header-repeat line-left minwidth-1"><a href="">Type Conge id</a>	</th> -->
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Type Conge libelle</a></th>
                                            ...
                                            foreach ($t as $key => $v) {
                                             ...
                                             //   echo"<td>" . $v->getId() . "</td>";
                                                ...
                                                echo "<a href=" . "../UpdateForm/TypeCongeUpdate.php?ide=" . $ide . "&id=" . $v->getId() . " title=Modifier class=icon-1 info-tooltip></a>";
                                                echo "<a href=" . "../DeleteForm/TypeCongeDelete.php?ide=" . $ide . "&id=" . $v->getId() . " title=Supprimer class=icon-2 info-tooltip></a>";
                                                echo "</td></tr>";
                                                $i++;
                                            }
                                            ?>
                                ...
                                <div id="actions-box">
                                    ...
                                    <div id="actions-box-slider">
                                        <a href="../Formulaire/TypeCongeForm.php?ide=<?php echo $ide; ?>" class="action-edit">Ajouter</a>

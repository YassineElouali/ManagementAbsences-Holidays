    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <h1>Liste des Absences Justifié :</h1>
                </div>
                <!-- end page-heading -->
                                        ...
                                        <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                            ...
                                            <tr>
                                               ...
                                               <!-- <th class="table-header-repeat line-left minwidth-1"><a href="">Absence id</a>	</th>-->
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Employe id</a></th> 
                                                ...
                                                <th class="table-header-repeat line-left minwidth-1"><a href="">Date de cette Absence</a></th>
                                            ...
                                            $i = 0;
                                            foreach ($t as $key => $v) {
                                                if ($v->getEtat()=="Justifie"){
                                                echo"<tr>";
                                                echo "<td><input type=checkbox name=check></td>";
                                                //echo"<td>" . $v->getId() . "</td>";
                                                $emp=$e->getById($v->getIde());
                                                echo"<td>" . $emp->getnom()." ".$emp->getPrenom() . "</td>";

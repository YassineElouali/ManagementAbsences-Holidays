...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="js/amcharts_3.14.5.free/amcharts/pie.js"></script>
        <script src="js/amcharts_3.14.5.free/amcharts/themes/light.js"></script>
        <link rel="stylesheet" href="css/screen.css" type="text/css" media="screen" title="default" />
        <script src="js/jquery/stat.js" type="text/javascript"></script>
...
//echo $b->getNom()." ".$b->getPrenom();
                ...
                ?>
                <fieldset><legend>
                        <h1>  Statistique d'un employé depuis sa date d'embauche jusqu'à aujourd'hui </h1></legend>
                <br>
                    <select name="emp" id="empp" onchange="fct();">
                                    <option value="NULL"> Liste Des Employés </option> 
                                    <?php
                                    foreach ($emp as $v) {
                ...
                <script>
                    function fct()
                    {
                      ...
                      var str=document.getElementById("empp").value;
                        ...
                        ajax.open('GET', 'statemp.php?id=' + str, true);

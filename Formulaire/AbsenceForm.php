    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Nouvelle d'absence :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../AddForm/AbsenceAdd.php?ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                        ...
                                                        <th valign="top"> Employé:</th>
                                                            <td>
                                                                    ...
                                                                    <select name="emp">
                                                                        ...
                                                                        foreach ($emp as $v) {
                                                                            echo "<option value=".$v->getId().">".$v->getId().": ".$v->getNom()." ".$v->getPrenom()."</option>";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="date" class="inp-form" name="jours"></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><textarea name="motif" rows="4" cols="20"></textarea> </td>
                                                        <td></td>
                                                    </tr>

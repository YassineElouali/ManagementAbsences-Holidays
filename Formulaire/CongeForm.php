    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Nouvelle demande de Conge :</h1></div>
                                ...
                                <?php
                                    ...
                                    /* Suppression */ {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=red-left >Période invalide !! </td>
                                    ...
                                    /* Suppression */ {
                                        ...
                                        echo "<table border=0 width=100% cellpadding=0 cellspacing=0>
                                            <tr>
                                                <td class=red-left >Solde insuffisant , veuillez diminuer la periode  !! </td>
                                                <td class=red-right ><a class=close-red><img src=images/table/icon_close_red.gif   alt= /></a></td>
                                            </tr>
                                        </table>
                                    </div>";
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../list/Congelist.php?ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                        ...
                                                        <td>
                                                            ...
                                                            <select name="Type"><?php
                                                                    ...
                                                                    foreach ($r as $c) {
                                                                        ...
                                                                        <option value="<?php echo $c->getId(); ?>"> <?php echo $c->getLibelle(); ?></option>
                                                                    <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="date" name="Jdebut" value="" /></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="date" name="Jfin" value="" /></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>

    ...
    <body> 
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <div id="page-heading"><h1>Nouveau Employé :</h1></div>
                                ...
                                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <form method="POST" action="../AddForm/EmployeAdd.php?ide=<?php echo $ide; ?>">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="prenom"></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="adresse"></td>
                                                        <td></td>
                                                    </tr>
                                                        ...
                                                        <td><input type="text" class="inp-form" name="mdpp"></td>
                                                        <td></td>
                                                    </tr>
                                                        <tr>
                                                       
                                                        <th valign="top">Salaire :</th>
                                                        <td><input type="text" class="inp-form" name="salaire"></td>
                                                        <td></td>
                                                    </tr>
